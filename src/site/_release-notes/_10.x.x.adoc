...
* Update `github/codeql-action` to version `3.24.0` (https://github.com/apache/logging-parent/pull/113[113])
* Update `org.asciidoctor:asciidoctor-maven-plugin` to version `2.2.6` (https://github.com/apache/logging-parent/pull/117[117])
