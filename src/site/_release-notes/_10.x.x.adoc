...
* Update `actions/upload-artifact` to version `4.1.0` (https://github.com/apache/logging-parent/pull/103[103])
* Update `com.diffplug.spotless:spotless-maven-plugin` to version `2.42.0` (https://github.com/apache/logging-parent/pull/100[100])
